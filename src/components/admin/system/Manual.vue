  ...
  <v-app>
    <v-container>
      ...
      <v-layout align-baseline wrap>
        <v-flex xs12 sm6 md4 d-flex></v-flex>
        <v-flex></v-flex>
      </v-layout>
      ...
      <v-data-table
        ...
        :items-per-page="5"
      ></v-data-table>
      <v-card class="elevation-1 mt-3" tile>
        ...
        <v-card-text>
          ...
          <v-list>
            ...
            <v-list-item v-if="selected">
              <v-list-item-title v-for="select in selected" :key="select.id">
            ...
            <v-list-item v-else>
              <v-list-item-title>ชื่อ-สกุล: - <br>
                  รหัสนักศึกษา: - <br>
                  GPAX: -
              </v-list-item-title>
            </v-list-item>
  ...
  methods: {
    ...
    registerSave: function() {
      if (this.selected && this.teach !== "") {
        this.result.push({
          gpax: this.selected[0].gpax,
          student: this.selected[0].id,
